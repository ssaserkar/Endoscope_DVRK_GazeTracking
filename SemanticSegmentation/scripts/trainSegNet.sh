...
dataset="cholec"
data_dir="/home/usivaraman/dl/ARCSeg-main/src/data/datasets/cholec"
json_path="/home/usivaraman/dl/ARCSeg-main/src/data/classes/${dataset}SegClasses.json"
